...
Markdown makes it easy to format text. You can write in **imrankhan bold**, *imrankhan italic*, or ~~strikethrough~~. Combine them for ***bold imrankhan.italic*** text. Use `inline code` for technical terms.
